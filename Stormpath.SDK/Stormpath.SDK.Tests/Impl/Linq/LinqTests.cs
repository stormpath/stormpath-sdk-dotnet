    ...
    public class LinqTests
    {
        ...
        public class FilterExtensionMethod
        {
            ...
            public void Filter_with_simple_parameter()
            {
                ...
                // Assert
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?q=Joe");
            }
            ...
            public void Filter_multiple_calls_are_LIFO()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?q=Joey");
            }
        }
        ...
        public class ExpandExtensionMethod
        {
            ...
            public void Expand_one_link()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=directory");
            }
            ...
            public void Expand_multiple_links()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=directory,tenant");
            }
            ...
            public void Expand_collection_query_with_offset()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=groups(offset:10)");
            }
            ...
            public void Expand_collection_query_with_limit()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=groups(limit:20)");
            }
            ...
            public void Expand_collection_query_with_both_parameters()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=groups(offset:5,limit:15)");
            }
            ...
            public void Expand_all_the_things()
            {
                ...
                harness.DataStore.Received().GetCollection<IAccount>($"{Url}/{Resource}?expand=tenant,groups(offset:10,limit:20),directory");
            }
