...
namespace Stormpath.SDK.Tests.Impl.Cache
{
    public class InMemoryCacheProviderBuilder_tests
    {
        ...
        public void Caches_without_configuration_are_created_with_default_TTL_and_TTI()
        {
            ...
            var cache = cacheProvider.GetSyncCache<string, object>("foobar");
        ...
        public void Combining_configuration_options()
        {
            ...
            var accountCache = cacheProvider.GetSyncCache<string, object>(nameof(Account.IAccount));
            var applicationCache = cacheProvider.GetSyncCache<string, object>(nameof(Application.IApplication));
            var directoryCache = cacheProvider.GetSyncCache<string, object>(nameof(Directory.IDirectory));
