...
namespace Stormpath.SDK.Cache
{
    ...
    public static class Caches
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ICacheProvider"/> that disables caching entirely.  While production applications
        ...
        /// </summary>
        /// <returns>A new disabled <see cref="ICacheProvider"/> instance.</returns>
