...
namespace Stormpath.SDK.Application
{
    ...
    public interface IApplication : IResource, ISaveableWithOptions<IApplication>, IDeletable, IAuditable, IExtendable, IAccountCreationActions, IGroupCreationActions
    {
        ...
        Task<IAccountStoreMapping> AddAccountStoreAsync(IAsyncQueryable<IDirectory> directoryQuery, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<IAccountStoreMapping> AddAccountStoreAsync(IAsyncQueryable<IGroup> groupQuery, CancellationToken cancellationToken = default(CancellationToken));
