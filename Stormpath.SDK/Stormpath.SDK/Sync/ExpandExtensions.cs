...
namespace Stormpath.SDK.Sync
{
    public static class ExpandExtensions
    {
        ...
        public static IQueryable<TSource> Expand<TSource, TExpand>(this IQueryable<TSource> source, Func<TSource, TExpand> selector)
        {
        ...
        /// <returns>An <see cref="IAsyncQueryable{T}"/> whose elements will include additional data selected by <paramref name="selector"/>.</returns>
        public static IQueryable<TSource> Expand<TSource, TExpand>(this IQueryable<TSource> source, Func<TSource, TExpand> selector, int? offset = null, int? limit = null)
        {
