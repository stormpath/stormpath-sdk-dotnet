...
namespace Stormpath.SDK.Sync
{
    ...
    public static class SyncAccountStoreContainerExtensions
    {
        ...
        /// <summary>
        /// Synchronously adds a new <see cref="IAccountStore"/> to the Application or Organization. The given string can either be an <c>href</c> or a name of a
...
#pragma warning disable SA1402 // Files may only contain one class. TODO will refactor when making breaking version change.
    ...
    {
        /// <summary>
        /// Synchronously adds a resource of type <typeparamref name="T"/> as a new <see cref="IAccountStore"/> to the Application. The provided query
    ...
    {
        /// <summary>
        /// Synchronously adds a resource of type <typeparamref name="T"/> as a new <see cref="IAccountStore"/> to the Organization. The provided query
        /// must match a single <typeparamref name="T"/> in the current <see cref="Tenant.ITenant">Tenant</see>. If no compatible resource matches the query, this method will return <see langword="null"/>.
        /// </summary>
