// <copyright file="DefaultCreateProviderRequest.cs" company="Stormpath, Inc.">
...
{
    internal sealed class DefaultCreateProviderRequest : ICreateProviderRequest
    {
        ...
        IProvider ICreateProviderRequest.GetProvider()
            => this.provider;
    }
}
