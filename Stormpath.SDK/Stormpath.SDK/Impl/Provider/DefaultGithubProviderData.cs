// <copyright file="DefaultGithubProviderData.cs" company="Stormpath, Inc.">
...
{
    internal sealed class DefaultGithubProviderData : AbstractProviderData, IGithubProviderData
    {
        private static readonly string AccessTokenPropertyName = "accessToken";

        public DefaultGithubProviderData(IInternalDataStore dataStore)
            : base(dataStore)
        {
        }

        public DefaultGithubProviderData(IInternalDataStore dataStore, IDictionary<string, object> properties)
