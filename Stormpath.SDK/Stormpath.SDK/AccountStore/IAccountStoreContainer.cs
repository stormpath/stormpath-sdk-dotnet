...
namespace Stormpath.SDK.AccountStore
{
    ...
    public interface IAccountStoreContainer : IResource, IHasTenant
    {
        ...
        /// <summary>
        /// Sets the <see cref="IAccountStore"/> (either a <see cref="Group.IGroup"/> or a <see cref="Directory.IDirectory"/>)
        ...
        /// <summary>
        /// Gets the <see cref="IAccountStore"/> used to persist new <see cref="Group.IGroup">Groups</see>, or <see langword="null"/>
