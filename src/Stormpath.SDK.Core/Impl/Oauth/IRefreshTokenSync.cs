// <copyright file="IRefreshTokenSync.cs" company="Stormpath, Inc.">
...
namespace Stormpath.SDK.Impl.Oauth
{
    ...
    /// available on <see cref="SDK.Oauth.IRefreshToken"/>.
    /// </summary>
    internal interface IRefreshTokenSync :
        IHasTenantSync,
        IDeletableSync
    {
        /// <summary>
        /// Synchronous counterpart to <see cref="SDK.Oauth.IRefreshToken.GetAccountAsync(System.Threading.CancellationToken)"/>.
        /// </summary>
