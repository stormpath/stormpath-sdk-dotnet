// <copyright file="DefaultRefreshGrantRequestBuilder.cs" company="Stormpath, Inc.">
...
namespace Stormpath.SDK.Impl.Oauth
{
    ...
    internal sealed class DefaultRefreshGrantRequestBuilder : IRefreshGrantRequestBuilder
    {
