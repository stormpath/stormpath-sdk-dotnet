...
namespace Stormpath.SDK.Impl.DataStore
{
    internal sealed class ResourceTypeLookup
    {
        private static readonly IReadOnlyDictionary<Type, Type> ConcreteLookup = new Dictionary<Type, Type>()
        {
            ...
            [typeof(ISamlProvider)] = typeof(DefaultSamlProvider),
            [typeof(IAdLdapProvider)] = typeof(DefaultAdLdapProvider),
            [typeof(ITwitterProvider)] = typeof(DefaultTwitterProvider),
            [typeof(IOauth2Provider)] = typeof(DefaultOauth2Provider),
        ...
        private static readonly IReadOnlyDictionary<Type, Type> InterfaceLookup = new Dictionary<Type, Type>()
        {
            ...
            [typeof(DefaultSamlProvider)] = typeof(ISamlProvider),
            [typeof(DefaultAdLdapProvider)] = typeof(IAdLdapProvider),
            [typeof(DefaultTwitterProvider)] = typeof(ITwitterProvider),
            [typeof(DefaultOauth2Provider)] = typeof(IOauth2Provider),
