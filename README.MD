# Stormpath .NET SDK  [![Build Status](https://travis-ci.org/stormpath/stormpath-sdk-csharp.svg?branch=develop)](https://travis-ci.org/stormpath/stormpath-sdk-csharp)
