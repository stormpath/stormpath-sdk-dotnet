# Stormpath .NET SDK  [![Build status](https://ci.appveyor.com/api/projects/status/f80jk6h98ewgf3md?svg=true)](https://ci.appveyor.com/project/nbarbettini/stormpath-sdk-dotnet)
