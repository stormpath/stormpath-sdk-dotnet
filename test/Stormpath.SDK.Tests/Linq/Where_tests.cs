...
namespace Stormpath.SDK.Tests.Linq
{
    public class Where_tests : Linq_test<IAccount>
    {
        ...
        public async Task Where_attribute_starts_with()
        {
            ...
            this.ShouldBeCalledWithArguments("email=tk421*");
        }
        ...
        public async Task Where_attribute_ends_with()
        {
            ...
            this.ShouldBeCalledWithArguments("email=*deathstar.co");
        }
        ...
        public async Task Where_attribute_contains()
        {
            ...
            this.ShouldBeCalledWithArguments("email=*421*");
        }
        ...
        public async Task Where_multiple_attributes_with_and()
        {
            ...
            this.ShouldBeCalledWithArguments("email=tk421%40deathstar.co", "username=tk421");
        }
        ...
        public async Task Where_date_attribute_greater_than()
        {
            ...
            this.ShouldBeCalledWithArguments("createdAt=(2015-01-01T06:00:00Z,]");
        }
        ...
        public async Task Where_date_attribute_less_than()
        {
            ...
            this.ShouldBeCalledWithArguments("modifiedAt=[,2016-01-01T12:00:00Z)");
        }
        ...
        public async Task Where_date_attribute_between()
        {
            ...
            this.ShouldBeCalledWithArguments("createdAt=(2015-01-01T00:00:00Z,2015-12-31T23:59:59Z]");
        }
        ...
        public async Task Where_date_attribute_using_implicit_DateTime()
        {
            ...
            this.ShouldBeCalledWithArguments($"modifiedAt=[,2016-01-01T{adjustedHour}:00:00Z)");
        }
