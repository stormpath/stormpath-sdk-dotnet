// <copyright file="ExceptionTests.cs" company="Stormpath, Inc.">
...
namespace Stormpath.SDK.Tests.IdSite
{
    public class ExceptionTests
    {
        ...
        public static IEnumerable<object[]> TestCases()
        {
            ...
            yield return new object[] { nameof(ExpiredJwt), ExpiredJwt, typeof(ExpiredJwtException), 0, 0, $"JWT expired at 2015-08-27T19:51:00.000Z. Current time: ", null };
        }
    }
}
